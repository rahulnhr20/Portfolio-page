  ...
  return (
    <div className="min-h-screen font-[family-name:var(--font-geist-sans)] selection:bg-[#52D68C] selection:text-black text-white relative">
      ...
      <main className="relative z-10 w-full">
        {/* HERO SECTION */}
        <section className="min-h-[80vh] flex flex-col justify-center px-6 md:px-12 pt-32 pb-20 max-w-[1600px] mx-auto">
          <FadeInBlock delay={0.1}>
            <h1 className="text-[14vw] leading-[0.85] font-medium tracking-tight mb-8">
              <ScrambleText text="Portfolio" autoStart />
            </h1>
          </FadeInBlock>

          <FadeInBlock delay={0.3}>
            <p className="text-xl md:text-3xl text-white/80 max-w-4xl leading-tight font-light border-b border-white/20 pb-12 mb-12">
