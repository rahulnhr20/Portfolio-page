...
import web_dev1 from "./web_dev1.png";
import web_dev2 from "./web_dev2.png";
import web_dev3 from "./web_dev3.png";
import web_dev4 from "./web_dev4.png";
import web_dev5 from "./web_dev5.png";

export const workImages = {
  branding: [b1, b2, b3, b4, b5],
  content: [cc1, cc2, cc3],
  digitalMarketing: [dm1, dm2, dm3, dm4, dm5],
  seo: [seo1, seo2, seo3, seo4, seo5],
  webDev: [web_dev1, web_dev2, web_dev3, web_dev4, web_dev5],
};
